...
//			strcat(output, HALF);
//		}
//	} else if (special_flag == SecondthFlag) {
//		if (ordinal_plural) {
//			strcat(output, SECONDTHS);
//		} else {
//			strcat(output, SECONDTH);
//		}
//	} else if (special_flag == QuarterFlag) {
//		if (ordinal_plural) {
...
//		case '9':
//			if (decimal_ || slash_) {
//				if (++fractionalDigits_ > FractionalDigitsMax) {
//					degenerate_++;
//				} else {
//					fractionalDigitsPos_[fractionalDigits_ - 1] = i;
//				}
//			} else {
//				if (++integerDigits_ > IntegerDigitsMax) {
//					degenerate_++;
//				} else {
...
*			Returns NoNumerals if the word contains no digits,
